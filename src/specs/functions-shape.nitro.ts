...
import type {
    ...
    RetrievalModes,
    ShapeMatchModes,
} from "./constants-image-processing";
...
export interface Shape extends HybridObject<{ios: "c++"; android: "c++"}> {
    /**
     ...
     */
    approxPolyDP(
        curve: CvMat | MatVector | PointVector,
        approxCurve: CvMat | PointVector,
        epsilon: number,
        closed: boolean
    ): void;
