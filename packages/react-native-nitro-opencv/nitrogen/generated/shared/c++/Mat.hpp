...
namespace margelo::nitro::nitroopencv {
  ...
  /**
   * A struct which can be represented as a JavaScript object (Mat).
   */
  struct Mat {
  public:
  ...
  public:
    Mat() = default;
    explicit Mat(double cols, double rows, Size size, std::string base64): cols(cols), rows(rows), size(size), base64(base64) {}
  };
...
namespace margelo::nitro {
  ...
  // C++ Mat <> JS Mat (object)
  template <>
  struct JSIConverter<Mat> final {
    static inline Mat fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const Mat& arg) {
