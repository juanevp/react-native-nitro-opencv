...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<Size> final {
    static inline Size fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const Size& arg) {
