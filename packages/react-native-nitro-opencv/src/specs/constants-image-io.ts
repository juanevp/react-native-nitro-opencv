...
export enum ImwriteEXRCompressionFlags {
...
export enum ImwriteEXRTypeFlags {
...
export enum ImwriteGIFCompressionFlags {
...
export enum ImwriteHDRCompressionFlags {
    IMWRITE_HDR_COMPRESSION_NONE = 0,
    IMWRITE_HDR_COMPRESSION_RLE = 1,
}

export enum ImwriteJPEGSamplingFactorParams {
...
export enum ImwriteTiffCompressionFlags {
...
export enum ImwriteTiffPredictorFlags {
