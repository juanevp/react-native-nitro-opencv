...
import type { ContourApproximationModes, DistanceTypes, RetrievalModes, ShapeMatchModes } from "./constants-image-processing";
import type { MatVector } from "./mat-vector.nitro";
import type { CvMat } from "./mat.nitro";
import type { PointVector, PointVectorOfVectors } from "./point-vector.nitro";
import type { CvRect } from "./rect.nitro";
import type { CvRotatedRect } from "./rotated-rect.nitro";
export interface Shape extends HybridObject<{
    ios: "c++";
    android: "c++";
}> {
    /**
     ...
     */
    approxPolyDP(curve: CvMat | MatVector | PointVector, approxCurve: CvMat | PointVector, epsilon: number, closed: boolean): void;
    /**
     ...
     */
    arcLength(curve: CvMat | MatVector | PointVector, closed: boolean): number;
    /**
     ...
     */
    boundingRect(array: CvMat | MatVector | PointVector): CvRect;
    /**
     ...
     * @returns N, the total number of labels [0, N-1] where 0 represents the background label
     */
    connectedComponentsWithStats(image: CvMat, labels: CvMat, stats: CvMat, centroids: CvMat): number;
    /**
     ...
     */
    contourArea(contour: CvMat | MatVector | PointVector, oriented?: boolean): number;
    /**
     ...
     */
    convexityDefects(contour: CvMat, convexHull: CvMat, convexityDefects: CvMat): void;
    /**
     ...
     */
    findContours(image: CvMat, contours: MatVector | PointVectorOfVectors, mode: RetrievalModes, method: ContourApproximationModes): void;
    /**
     ...
     */
    fitLine(points: CvMat, line: CvMat, disType: DistanceTypes, param: number, reps: number, aeps: number): void;
    /**
     ...
     * @returns
     */
    matchShapes(contour1: CvMat, contour2: CvMat, method: ShapeMatchModes, parameter: number): number;
    /**
