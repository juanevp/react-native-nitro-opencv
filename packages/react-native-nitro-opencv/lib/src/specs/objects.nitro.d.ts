...
export interface Objects extends HybridObject<{
    ios: "c++";
    android: "c++";
}> {
     ...
     */
    arrayBufferToMat(itemType: ImportBufferItemType, rows: number, cols: number, channels: 1 | 3 | 4, input: ArrayBuffer): CvMat;
    /**
