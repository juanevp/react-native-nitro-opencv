...
export interface ImageFiltering extends HybridObject<{
    ios: "c++";
    android: "c++";
}> {
    /**
     ...
     */
    bilateralFilter(src: CvMat, dst: CvMat, d: number, sigmaColor: number, sigmaSpace: number, borderType: BorderTypes): void;
    /**
     *
     ...
     * @param borderType border mode used to extrapolate pixels outside of the image, see BorderTypes. BORDER_WRAP is not supported.
     */
    boxFilter(src: CvMat, dst: CvMat, ddepth: DataTypes, ksize: CvSize, anchor: CvPoint, normalize: boolean, borderType: BorderTypes): void;
    /**
     ...
     */
    dilate(src: CvMat, dst: CvMat, kernel: CvMat, anchor: CvPoint, iterations: number, borderType: BorderTypes, borderValue: CvScalar): void;
    /**
     ...
     * @param borderValue border value in case of a constant border
     */
    erode(src: CvMat, dst: CvMat, kernel: CvMat, anchor: CvPoint, iterations: number, borderType: BorderTypes, borderValue: CvScalar): void;
    /**
     ...
     */
    filter2D(src: CvMat, dst: CvMat, ddepth: number, kernel: CvMat, anchor: CvPoint, delat: number, borderType: BorderTypes): void;
    /**
     ...
     * @param borderType pixel extrapolation method, see BorderTypes. BORDER_WRAP is not supported.
     */
    GaussianBlur(src: CvMat, dst: CvMat, ksize: CvSize, sigmaX: number, sigmaY?: number, borderType?: BorderTypes): void;
    /**
     *
     ...
     */
    getGaborKernel(ksize: CvSize, sigma: number, theta: number, lambd: number, gamma: number, psi: number, ktype: DataTypes.Cv32F | DataTypes.Cv64F): CvMat;
    /**
     ...
     * @param borderType Pixel extrapolation method, see BorderTypes. BORDER_WRAP is not supported.
     */
    Laplacian(src: CvMat, dst: CvMat, ddepth: DataTypes, ksize: number, scale: number, delta: number, borderType: BorderTypes): void;
    /**
     ...
     */
    morphologyEx(src: CvMat, dst: CvMat, op: MorphTypes, kernel: CvMat, anchor?: CvPoint, iterations?: number, borderType?: BorderTypes, borderValue?: CvScalar): void;
    /**
     ...
     * @param borderType Pixel extrapolation method, see BorderTypes. BORDER_WRAP is not supported.
     */
    Sobel(src: CvMat, dst: CvMat, ddepth: number, dx: number, dy: number, ksize: 1 | 3 | 5 | 7, scale: number, delta: number, borderType: Exclude<BorderTypes, BorderTypes.BORDER_WRAP>): void;
}
