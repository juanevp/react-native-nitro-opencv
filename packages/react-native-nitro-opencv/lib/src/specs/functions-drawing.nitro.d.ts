...
export interface Drawing extends HybridObject<{
    ios: "c++";
    android: "c++";
}> {
    /**
     ...
     */
    drawContours(image: CvMat, contours: MatVector, contourIdx: number, color: CvScalar, thickness: number, lineType: LineTypes): void;
    /**
     ...
     */
    drawMarker(img: CvMat, position: CvPoint, color: CvScalar, markerType: MarkerTypes, markerSize: number, thickness: number, line_type: LineTypes): void;
    /**
     ...
     */
    ellipse(img: CvMat, center: CvPoint, axes: CvSize, angle: number, startAngle: number, endAngle: number, color: CvScalar, thickness: number, lineType: LineTypes): void;
    /**
     ...
     */
    polylines(img: CvMat, pts: MatVector, isClosed: boolean, color: CvScalar, thickness: number, lineType: LineTypes): void;
    /**
