...
import type { BorderTypes, CmpTypes, CovarFlags, DecompTypes, DftFlags, GemmFlags, NormTypes, ReduceTypes, RotateFlags, SortFlags } from "./constants-core";
...
export interface Core extends HybridObject<{
    ios: "c++";
    android: "c++";
}> {
    /**
     ...
     */
    batchDistance(src1: CvMat, src2: CvMat, dist: CvMat, dtype: number | DataTypes, nidx: CvMat, normType: NormTypes, K: number, mask: CvMat, update: number, crosscheck: boolean): void;
    /**
     ...
     */
    calcCovarMatrix(samples: MatVector, nsamples: number, covar: CvMat, mean: CvMat, flags: CovarFlags, ctype: DataTypes): void;
    /**
     ...
     */
    copyMakeBorder(src: CvMat, dst: CvMat, top: number, bottom: number, left: number, right: number, borderType: BorderTypes, value: CvScalar): void;
    /**
